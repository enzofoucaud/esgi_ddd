...
public class CreatedQuestionEvent implements Serializable {
    ...
    private NewQuestion questionAndTag;
    ...
    public NewQuestion getQuestionAndTag() {
        return this.questionAndTag;
    }

    public void setQuestionAndTag(NewQuestion newQuestion) {
        this.questionAndTag = newQuestion;
    }

    public CreatedQuestionEvent questionAndTag(NewQuestion newQuestion) {
        this.setQuestionAndTag(newQuestion);
        return this;
    }
