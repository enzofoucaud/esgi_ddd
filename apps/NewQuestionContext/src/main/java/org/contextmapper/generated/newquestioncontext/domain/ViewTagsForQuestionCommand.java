...
public class ViewTagsForQuestionCommand implements Serializable {
    ...
    private NewQuestion questionToSend;
    ...
    public NewQuestion getQuestionToSend() {
        return this.questionToSend;
    }

    public void setQuestionToSend(NewQuestion newQuestion) {
        this.questionToSend = newQuestion;
    }

    public ViewTagsForQuestionCommand questionToSend(NewQuestion newQuestion) {
        this.setQuestionToSend(newQuestion);
        return this;
    }
