...
/**
 * A ResourceRejectedAssociationEvent.
 */
@Entity
@Table(name = "resource_rejected_association_event")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ResourceRejectedAssociationEvent implements Serializable {
    ...
    public ResourceRejectedAssociationEvent id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ResourceRejectedAssociationEvent questionId(QuestionResource questionResource) {
    ...
    public ResourceRejectedAssociationEvent tagInfos(QuestionResourceTagInfos questionResourceTagInfos) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceRejectedAssociationEvent)) {
            return false;
        }
        return id != null && id.equals(((ResourceRejectedAssociationEvent) o).id);
    }
