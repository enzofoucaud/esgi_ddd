...
class EvaluationResourceIT {
    ...
    private static final Difficulty DEFAULT_ANSWERED_QUESTION_DIFFICULTY = Difficulty.BEGINNER;
    private static final Difficulty UPDATED_ANSWERED_QUESTION_DIFFICULTY = Difficulty.INTERMEDIATE;
    ...
    public static Evaluation createEntity(EntityManager em) {
        Evaluation evaluation = new Evaluation()
            ...
            .answeredQuestionDifficulty(DEFAULT_ANSWERED_QUESTION_DIFFICULTY);
        return evaluation;
    }
    ...
    public static Evaluation createUpdatedEntity(EntityManager em) {
        Evaluation evaluation = new Evaluation()
            ...
            .answeredQuestionDifficulty(UPDATED_ANSWERED_QUESTION_DIFFICULTY);
        return evaluation;
    }
    ...
    void createEvaluation() throws Exception {
        ...
        assertThat(testEvaluation.getAnsweredQuestionDifficulty()).isEqualTo(DEFAULT_ANSWERED_QUESTION_DIFFICULTY);
    }
    ...
    void getAllEvaluations() throws Exception {
        ...
        restEvaluationMockMvc
            ...
            .andExpect(jsonPath("$.[*].answeredQuestionDifficulty").value(hasItem(DEFAULT_ANSWERED_QUESTION_DIFFICULTY.toString())));
    }
    ...
    void getEvaluation() throws Exception {
        ...
        restEvaluationMockMvc
            ...
            .andExpect(jsonPath("$.answeredQuestionDifficulty").value(DEFAULT_ANSWERED_QUESTION_DIFFICULTY.toString()));
    }
    ...
    void putExistingEvaluation() throws Exception {
        ...
        assertThat(testEvaluation.getAnsweredQuestionDifficulty()).isEqualTo(UPDATED_ANSWERED_QUESTION_DIFFICULTY);
    }
