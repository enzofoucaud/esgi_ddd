...
public class Evaluation implements Serializable {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "answered_question_difficulty")
    ...
    public Difficulty getAnsweredQuestionDifficulty() {
        return this.answeredQuestionDifficulty;
    }

    public Evaluation answeredQuestionDifficulty(Difficulty answeredQuestionDifficulty) {
        this.setAnsweredQuestionDifficulty(answeredQuestionDifficulty);
        return this;
    }
