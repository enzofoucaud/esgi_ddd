...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.EarnPoint.class.getName());
            ...
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.QuestionEvaluationViewedEvent.class.getName());
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.TagEvaluationViewedEvent.class.getName());
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.UserAndLevel.class.getName());
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.UserEvaluationViewedEvent.class.getName());
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.ViewQuestionEvaluationCommand.class.getName());
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.ViewTagEvaluationCommand.class.getName());
            createCache(cm, org.contextmapper.generated.evaluationcontext.domain.ViewUserEvaluationCommand.class.getName());
