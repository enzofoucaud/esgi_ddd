...
public class Answer implements Serializable {
    ...
    private NewQuestionId question;
    ...
    public NewQuestionId getQuestion() {
        return this.question;
    }

    public void setQuestion(NewQuestionId newQuestionId) {
        this.question = newQuestionId;
    }

    public Answer question(NewQuestionId newQuestionId) {
        this.setQuestion(newQuestionId);
        return this;
    }
