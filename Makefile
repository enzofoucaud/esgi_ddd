...
ordered_list=gamedev_ContextMap BC_UserManagementContext_User BC_QuestionContext BC_SkillContext BC_NewQuestionContext BC_AnswerContext BC_EvaluationContext BC_StatContext
...
microservices:=UserManagementContext QuestionContext SkillContext NewQuestionContext AnswerContext EvaluationContext StatContext
...
all-client:
	...
	$(MAKE) UserManagementContext.client APP=NewQuestionContext
	$(MAKE) UserManagementContext.client APP=AnswerContext
	$(MAKE) QuestionContext.client APP=NewQuestionContext
	$(MAKE) SkillContext.client APP=NewQuestionContext
	$(MAKE) NewQuestionContext.client APP=AnswerContext
